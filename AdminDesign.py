...
class AdminDesign:
   def __init__(self,root):
     ...
     self.txt_doj=ttk.Entry(upper_frame,textvariable=self.var_doj,width=22,font=('arial','11','bold'))
     ...
     btn_frame=Frame(upper_frame,bg="white",relief=RIDGE)
     btn_frame.place(x=1100,y=1,width=200,height=180)   

     b=Button(btn_frame,text="ADD",font=('times new roman',15,'bold'),command=self.add_data,width=13,height=0,bg='blue',fg='black')
     b.grid(row=0,column=0,padx=10,pady=2)

     c=Button(btn_frame,text="UPDATE",font=('times new roman',15,'bold'),command=self.update_data,width=13,bg='blue',fg='black')
     c.grid(row=1,column=0,padx=10,pady=2)

     d=Button(btn_frame,text="DELETE",font=('times new roman',15,'bold'),command=self.delete_data,width=13,bg='blue',fg='black')
     d.grid(row=2,column=0,padx=10,pady=2)

     e=Button(btn_frame,text="View",font=('times new roman',15,'bold'),width=13,bg='blue',fg='black')
     e.grid(row=3,column=0,padx=10,pady=2)
     ...
     #lower frame
     lower_frame=LabelFrame(Main_frame, bd=2, relief=RIDGE, bg= "white",text="Employee Information Table",font=('times new roman',15,'bold'),fg='red')
     lower_frame.place(x=10,y=240, width=1500,height=420)
     ...
     self.combo_search_by=ttk.Combobox(search_frame,textvariable=self.var_com_search,font=('arial', 12,'bold'),width=18,state='readonly')
     ...
     button_Show_all= Button(search_frame,text = 'Show All',command=self.fetch_data, font=('arial', 11,'bold'),width=18,foreground='white',background='darkblue')
