...
class EmpDesign:
   def __init__(self,root):
     ...
     upper_frame=LabelFrame(Main_frame, bd=2, relief=RIDGE, bg= "white",text="EmployeeInformation",font=('times new roman',15,'bold'),fg='red')
     upper_frame.place(x=10,y=10, width=1500,height=205)

     #empid
     lbl_EmpId=Label(upper_frame,text="Emp Id",font=('arial','11','bold',),bg='white' )
     ...
     #empname
     lbl_Empname=Label(upper_frame,text="Empname",font=('arial','11','bold',),bg='white')
     ...
     #empdepartment
     lbl_Department=Label(upper_frame,text="Department",font=('arial','11','bold',),bg='white' )
     lbl_Department.grid(row=2,column=0,padx=2,sticky=W,pady=5)

     self.combo_Department=ttk.Combobox(upper_frame,font=('arial','11','bold'),textvariable=self.var_dept,width=20,state='readonly')
     ...
     #empdesignation
     lbl_Designation=Label(upper_frame,text="Designation",font=('arial','10','bold',),bg='white' )
     lbl_Designation.grid(row=3,column=0,padx=2,sticky=W,pady=5)
     
     self.combo_Designation=ttk.Combobox(upper_frame,font=('arial','10','bold'),textvariable=self.var_design,width=23,state='readonly')
     ...
     #empEmail
     lbl_EmailId=Label(upper_frame,text="Email ID",font=('arial','11','bold',),bg='white' )
     ...
     self.txt_dob=ttk.Entry(upper_frame,textvariable=self.var_dob,width=22,font=('arial','11','bold'))
     ...
     self.combo_Gender=ttk.Combobox(upper_frame,font=('arial','11','bold'),textvariable=self.var_gender,width=20,state='readonly')
     ...
     #empTotalLeave
     lbl_Total_leave=Label(upper_frame,text="Total Leave",font=('arial','11','bold',),bg='white' )
     ...
     self.txt_doj=ttk.Entry(upper_frame,width=22,textvariable=self.var_doj,font=('arial','11','bold'))
     ...
     btn_frame=Frame(upper_frame,bg="black",relief=RIDGE)
     btn_frame.place(x=1100,y=15,width=200,height=150)   

     b=Button(btn_frame,text="Update",command=self.update_data,font=('times new roman',15,'bold'),width=13,bg='blue',fg='black')
     ...
     #lower frame
     lower_frame=LabelFrame(Main_frame, bd=2, relief=RIDGE, bg= "blue",text="Employee Information Table",font=('times new roman',15,'bold'),fg='red')
     lower_frame.place(x=10,y=230, width=1500,height=420)

     #search frame
     search_frame = LabelFrame(lower_frame, bd=2, relief=RIDGE, background='white',text='Search Employee Information', font=('times new roman', 14,'bold'),foreground='black')
     search_frame.place(x=10, y=10,width=1340,height=70)
     ...
     combo_search_by=ttk.Combobox(search_frame,textvariable=self.var_com_search,font=('arial', 12,'bold'),width=18,state='readonly')
     ...
     button_Search_all= Button(search_frame, text = 'Search All',command=self.fetch_data,font=('arial', 11,'bold'),width=18,foreground='white',background='darkblue')
     button_Search_all.grid(row=0, column=4, padx=10,pady=10)

    #table frame
     table_frame = Frame(lower_frame, bd=3, relief=RIDGE)
     table_frame.place(x=10, y=80,width=1340,height=290)
